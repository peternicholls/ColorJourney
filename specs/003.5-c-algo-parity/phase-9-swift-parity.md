...
- `specs/005-c-algo-parity/corpus/default.json` (3 baseline cases)
- `specs/005-c-algo-parity/corpus/edge-cases.json` (4 boundary cases)
...
**Location**: `specs/005-c-algo-parity/tools/swift-parity-runner/`
...
**Location**: `specs/005-c-algo-parity/` (Phase 9 tasks)
...
- [ ] **T064** Wire Makefile target in `specs/005-c-algo-parity/` for building Swift runner
...
- [ ] **T075** Integrate Swift parity into existing `.github/workflows/` (runs on 005-c-algo-parity pushes)
...
**Trigger**: Pushes to `005-c-algo-parity` branch only
